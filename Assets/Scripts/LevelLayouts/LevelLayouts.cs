...
public class LevelLayouts {
    ...
    public BoardModel.SquareType[,] Level1()
    {
        return new BoardModel.SquareType[,]
            ...
            { BoardModel.SquareType.EDGE_OF_BOARD, BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0},
            { BoardModel.SquareType.EDGE_OF_BOARD, BoardModel.SquareType.TARGET_H0_UNLIT, BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0},
            { BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0, BoardModel.SquareType.EMPTY_H0 }
         };
    }
}
